...
\begin{enumerate}
    \item Pregunta aqu\'i %{\input{/Users/hectorbahamonde/RU/Teaching/Teaching_Questions_Database/Ciencia_Social_ESP/1_esp.txt}\unskip}
    
    \item Pregunta aqu\'i %{\input{/Users/hectorbahamonde/RU/Teaching/Teaching_Questions_Database/Ciencia_Social_ESP/2_esp.txt}\unskip}
\end{enumerate}    
...
\begin{enumerate}
    \item Pregunta aqu\'i %{\input{/Users/hectorbahamonde/RU/Teaching/Teaching_Questions_Database/Ciencia_Social_ESP/3_esp.txt}\unskip} 
    
   \item Pregunta aqu\'i %{\input{/Users/hectorbahamonde/RU/Teaching/Teaching_Questions_Database/Ciencia_Social_ESP/4_esp.txt}\unskip} 
\end{enumerate}    

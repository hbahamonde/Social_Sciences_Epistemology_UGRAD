...
% Set your name here
\def\name{Introduction to Social Sciences and Social Epistemology}
...
\usepackage{csquotes}
\usepackage[backend=biber,style=authoryear,dashed=false,doi=false,isbn=false,url=false,eprint=false]{biblatex}

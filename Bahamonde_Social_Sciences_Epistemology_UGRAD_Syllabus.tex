...
~\\
		...
		\item {\bf Oct 10: Causal Inference, Mill's Method and Process-Tracing}
			\begin{itemize}
				...
				\item[$\bullet$] Alexander George and Andrew Bennett, ``Process-Tracing and Historical Explanation,'' in Alexander George and Andrew Bennett ``\emph{Case Studies and Theory Development in the Social Sciences},'' pp. 205-233. MIT Press, 2004.\phantom{\textcite{George:2005aa}}  
			\end{itemize}
		\end{itemize}

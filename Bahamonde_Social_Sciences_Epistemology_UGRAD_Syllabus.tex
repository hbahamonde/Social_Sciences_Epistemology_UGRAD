...
\\	
	...
	\\ 
	\\
	In this exercise, you should produce a research design paper that focuses on an specific topic in the social sciences. Please consult with me in advance what your thematic options are. Do not write your paper without first double-checking with me if the topic is appropriate. For those matters, please \href{https://calendly.com/bahamonde/officehours}{make an appointment} with me. Importantly, the paper should use at least \emph{three} different methods discussed in the course.
	...
	\\
	The paper is due in hard copy at {\input{/Users/hectorbahamonde/RU/Teaching/Social_Sciences_Epistemology_UGRAD/time_class_begins.txt}\unskip} on {\bf {\input{/Users/hectorbahamonde/RU/Teaching/Social_Sciences_Epistemology_UGRAD/date_design.txt}\unskip}}. Turning it in before the due date is OK, but \emph{not} afterwards. {\bf Late papers will not be accepted, and will be graded with a 1}. There will \emph{not} be exceptions or extensions. No electronic copies of any kind will be accepted.
	\\
	\\
...
\\
\\
If needed, the TA could spend up to one extra hour right after recitation, for example, in the library, solving additional questions. However, make sure you \href{mailto:ghbarria@uc.cl}{contact} {\input{/Users/hectorbahamonde/RU/Teaching/Social_Sciences_Epistemology_UGRAD/ta_name.txt}\unskip} 24 hours before recitation. Without this request, s/he is not obliged to stay at all. Bare in mind: it's a \emph{request}. The TA is free to decline the request.
\\
\\
...
~\\
		...
		\begin{itemize}
		\item {\bf September 24: Mechanisms}
			\begin{itemize}
...
\item {\bf Concept Formation and the Criterial Framework}
		...
		\begin{itemize}
		\item {\bf September 26: Concept Formation}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf October 1: The Criterial Approach}
			\begin{itemize}
...
\item[] \begin{center}{\color{blue}{\bf Midterm}: \underline{{\input{/Users/hectorbahamonde/RU/Teaching/Social_Sciences_Epistemology_UGRAD/date_midterm.txt}\unskip}.}}\end{center}
	~\\ 
	\vspace{-1cm}\begin{center}$\uparrow$ {\color{blue}For the test, keep calm, and study everything that's above.} $\uparrow$ \end{center}
	~\\
	\vspace{-1.5cm}\begin{center}\Smiley{} {\color{blue}You can do this} \Smiley{} \end{center}
	~\\ 

\vspace{-1cm}
\item[] \begin{center}{\color{blue}{\bf $\downarrow$ Now, for your design, pick \emph{three} of the following methods $\downarrow$}} \end{center}
\vspace{-0.05cm}

\item {\bf Case Study Designs (1)}
		
		\begin{itemize}
		\item {\bf October 8: Defining Case Studies and Single Case Designs}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf October 10: Causal Inference, Mill's Method and Process-Tracing}
			\begin{itemize}
...
\item {\bf Case Study Designs (2)}
		...
		\begin{itemize}
		\item {\bf October 15: Structured, Focused Comparisons}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf October 17: Comparative Case Study Designs}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf October 22: Case Selection}
			\begin{itemize}
...
\item {\bf Historical Analyses}
		...
		\begin{itemize}
		\item {\bf October 24: Macro-Historical Analysis and Comparison}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf October 29: Path Dependence}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf October 31: Counterfactual Analysis}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf November 5: Thinking about Temporality}
			\begin{itemize}
...
\item {\bf Field Research Techniques (1)}
		...
		\begin{itemize}
		\item {\bf November 7: The Ethics of Working with Human Subjects}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf November 12: Conducting Elite Interviews}
			\begin{itemize}
		...
		\end{itemize}
				...
				\begin{itemize}
		\item {\bf November 14: Focus Groups}
			\begin{itemize}
...
\item {\bf Field Research Techniques (2)}
		...
		\begin{itemize}
		\item {\bf November 19: Ethnography}
			\begin{itemize}
...
\item {\bf Field Research Techniques (3)}
		...
		\begin{itemize}
		\item {\bf November 21: Archival Methods}
			\begin{itemize}
		...
		\begin{itemize}
		\item {\bf November 26: Overcoming Selection Bias}
			\begin{itemize}
